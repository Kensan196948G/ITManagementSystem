...
describe('Audit Error Classes', () => {
  describe('AuditError', () => {
    it('基本的なエラーメッセージと情報を保持すること', () => {
      const error = new AuditError('Test error', 'TEST_ERROR', 400);
    ...
    it('追加の詳細情報を保持できること', () => {
      ...
      const error = new AuditError('Test error', 'TEST_ERROR', 400, details);
  ...
  describe('AuditValidationError', () => {
    it('バリデーションエラー情報を正しく設定すること', () => {
      ...
      const error = new AuditValidationError('Validation failed', details);
  ...
  describe('AuditDatabaseError', () => {
    it('データベースエラー情報を正しく設定すること', () => {
      ...
      const error = new AuditDatabaseError('Database error', details);
